...
class TMDBTVDetailViewController: UIViewController {
    ...
    @IBOutlet weak var networkCollectionView: UICollectionView! {
        didSet {
            networkCollectionView.collectionViewLayout = Layout.imageLayout(fractionWidth: 0.2, fractionHeight: 1, scrollBehavior: .continuous)
    ...
    @IBOutlet weak var matchingTVShowCollectionView: UICollectionView! {
        didSet {
            matchingTVShowCollectionView.collectionViewLayout = Layout.customLayout()
    ...
    @IBOutlet weak var tvShowCreditCollectionView: UICollectionView! {
        didSet {
            tvShowCreditCollectionView.collectionViewLayout = Layout.customLayout()
    ...
    @IBOutlet weak var creatorCollectionView: UICollectionView! {
        didSet {
            creatorCollectionView.collectionViewLayout = Layout.customLayout()
