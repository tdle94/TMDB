// MARK: - Mocks generated from file: TMDB/TMDBLocalDataSource/TMDBLocalDataSource.swift at 2020-07-16 17:43:02 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBRepository/TMDBRepository.swift at 2020-07-16 17:43:02 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBSession.swift at 2020-07-16 17:43:02 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLRequestBuilder.swift at 2020-07-16 17:43:02 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLSessionDataTaskProtocol.swift at 2020-07-16 17:43:02 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLSessionProtocol.swift at 2020-07-16 17:43:02 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBUserSetting/TMDBUserSetting.swift at 2020-07-16 17:43:02 +0000
...
import Foundation
 ...
 class MockTMDBUserSettingProtocol: TMDBUserSettingProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("getYoutubeURL(key: String) -> URL?",
            parameters: (key),
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getYoutubeURL(key: key))
	 ...
	 struct __StubbingProxy_TMDBUserSettingProtocol: Cuckoo.StubbingProxy {
	    ...
	    func getYoutubeURL<M1: Cuckoo.Matchable>(key: M1) -> Cuckoo.ProtocolStubFunction<(String), URL?> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: key) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBUserSettingProtocol.self, method: "getYoutubeURL(key: String) -> URL?", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_TMDBUserSettingProtocol: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getYoutubeURL<M1: Cuckoo.Matchable>(key: M1) -> Cuckoo.__DoNotUse<(String), URL?> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: key) { $0 }]
	        return cuckoo_manager.verify("getYoutubeURL(key: String) -> URL?", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
