// MARK: - Mocks generated from file: TMDB/TMDBLocalDataSource/TMDBLocalDataSource.swift at 2020-07-27 17:47:50 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBRepository/TMDBRepository.swift at 2020-07-27 17:47:50 +0000
...
import Foundation
 ...
 class MockTMDBRepositoryProtocol: TMDBRepositoryProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("getTVShowCast(from: Int) -> [Cast]",
            parameters: (tvShowId),
            escapingParameters: (tvShowId),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getTVShowCast(from: tvShowId))
    ...
    return cuckoo_manager.call("getTVShowCrew(from: Int) -> [Crew]",
            parameters: (tvShowId),
            escapingParameters: (tvShowId),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getTVShowCrew(from: tvShowId))
    ...
    return cuckoo_manager.call("multiSearch(query: String, page: Int, completion: @escaping (Result<MultiSearchResult, Error>) -> Void)",
	 ...
	 struct __StubbingProxy_TMDBRepositoryProtocol: Cuckoo.StubbingProxy {
	    ...
	    func getTVShowCast<M1: Cuckoo.Matchable>(from tvShowId: M1) -> Cuckoo.ProtocolStubFunction<(Int), [Cast]> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBRepositoryProtocol.self, method: "getTVShowCast(from: Int) -> [Cast]", parameterMatchers: matchers))
	    }
	    
	    func getTVShowCrew<M1: Cuckoo.Matchable>(from tvShowId: M1) -> Cuckoo.ProtocolStubFunction<(Int), [Crew]> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBRepositoryProtocol.self, method: "getTVShowCrew(from: Int) -> [Crew]", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_TMDBRepositoryProtocol: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getTVShowCast<M1: Cuckoo.Matchable>(from tvShowId: M1) -> Cuckoo.__DoNotUse<(Int), [Cast]> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return cuckoo_manager.verify("getTVShowCast(from: Int) -> [Cast]", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func getTVShowCrew<M1: Cuckoo.Matchable>(from tvShowId: M1) -> Cuckoo.__DoNotUse<(Int), [Crew]> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return cuckoo_manager.verify("getTVShowCrew(from: Int) -> [Crew]", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
 ...
 class MockTMDBRepository: TMDBRepository, Cuckoo.ClassMock {
    ...
    return cuckoo_manager.call("getTVShowKeywords(from: Int) -> [Keyword]",
     ...
     override func getTVShowCast(from tvShowId: Int) -> [Cast] {
    ...
    return cuckoo_manager.call("getTVShowCast(from: Int) -> [Cast]",
            ...
            superclassCall:
                ...
                super.getTVShowCast(from: tvShowId)
                ,
            defaultCall: __defaultImplStub!.getTVShowCast(from: tvShowId))
     ...
     override func getTVShowCrew(from tvShowId: Int) -> [Crew] {
    ...
    return cuckoo_manager.call("getTVShowCrew(from: Int) -> [Crew]",
            ...
            superclassCall:
                ...
                super.getTVShowCrew(from: tvShowId)
                ,
            defaultCall: __defaultImplStub!.getTVShowCrew(from: tvShowId))
    ...
    return cuckoo_manager.call("multiSearch(query: String, page: Int, completion: @escaping (Result<MultiSearchResult, Error>) -> Void)",
	 ...
	 struct __StubbingProxy_TMDBRepository: Cuckoo.StubbingProxy {
	    ...
	    func getTVShowCast<M1: Cuckoo.Matchable>(from tvShowId: M1) -> Cuckoo.ClassStubFunction<(Int), [Cast]> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBRepository.self, method: "getTVShowCast(from: Int) -> [Cast]", parameterMatchers: matchers))
	    }
	    
	    func getTVShowCrew<M1: Cuckoo.Matchable>(from tvShowId: M1) -> Cuckoo.ClassStubFunction<(Int), [Crew]> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBRepository.self, method: "getTVShowCrew(from: Int) -> [Crew]", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBSession.swift at 2020-07-27 17:47:50 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLRequestBuilder.swift at 2020-07-27 17:47:50 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLSessionDataTaskProtocol.swift at 2020-07-27 17:47:50 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLSessionProtocol.swift at 2020-07-27 17:47:50 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBUserSetting/TMDBUserSetting.swift at 2020-07-27 17:47:50 +0000
