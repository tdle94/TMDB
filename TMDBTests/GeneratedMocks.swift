// MARK: - Mocks generated from file: TMDB/TMDBLocalDataSource/TMDBLocalDataSource.swift at 2021-01-13 19:21:27 +0000
...
import RealmSwift
 ...
 class MockTMDBLocalDataSourceProtocol: TMDBLocalDataSourceProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("saveSimilarMovie(_: List<Movie>, to: Int)",
            parameters: (similarMovies, movieId),
            escapingParameters: (similarMovies, movieId),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.saveSimilarMovie(similarMovies, to: movieId))
    ...
    return cuckoo_manager.call("saveRecommendMovie(_: List<Movie>, to: Int)",
            parameters: (recommendMovies, movieId),
            escapingParameters: (recommendMovies, movieId),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.saveRecommendMovie(recommendMovies, to: movieId))
    ...
    return cuckoo_manager.call("saveSimilarTVShow(_: List<TVShow>, to: Int)",
            parameters: (similarTVShows, tvShowId),
            escapingParameters: (similarTVShows, tvShowId),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.saveSimilarTVShow(similarTVShows, to: tvShowId))
    ...
    return cuckoo_manager.call("saveRecommendTVShow(_: List<TVShow>, to: Int)",
            parameters: (recommendTVShows, tvShowId),
            escapingParameters: (recommendTVShows, tvShowId),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.saveRecommendTVShow(recommendTVShows, to: tvShowId))
    ...
    return cuckoo_manager.call("getTVShowSeason(tvShowId: Int, seasonNumber: Int) -> Season?",
     ...
     func getTVShowSeasons(tvShowId: Int) -> List<Season> {
        
    return cuckoo_manager.call("getTVShowSeasons(tvShowId: Int) -> List<Season>",
            parameters: (tvShowId),
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getTVShowSeasons(tvShowId: tvShowId))
    ...
    return cuckoo_manager.call("getTVShowSeasonCasts(from: Int, seasonNumber: Int) -> List<Cast>",
            parameters: (tvShowId, seasonNumber),
            escapingParameters: (tvShowId, seasonNumber),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getTVShowSeasonCasts(from: tvShowId, seasonNumber: seasonNumber))
    ...
    return cuckoo_manager.call("getTVShowSeasonCrews(from: Int, seasonNumber: Int) -> List<Crew>",
            parameters: (tvShowId, seasonNumber),
            escapingParameters: (tvShowId, seasonNumber),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getTVShowSeasonCrews(from: tvShowId, seasonNumber: seasonNumber))
    ...
    return cuckoo_manager.call("savePerson(_: People)",
	 ...
	 struct __StubbingProxy_TMDBLocalDataSourceProtocol: Cuckoo.StubbingProxy {
	    ...
	    func saveSimilarMovie<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ similarMovies: M1, to movieId: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(List<Movie>, Int)> where M1.MatchedType == List<Movie>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<Movie>, Int)>] = [wrap(matchable: similarMovies) { $0.0 }, wrap(matchable: movieId) { $0.1 }]
	    ...
	    func saveRecommendMovie<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ recommendMovies: M1, to movieId: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(List<Movie>, Int)> where M1.MatchedType == List<Movie>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<Movie>, Int)>] = [wrap(matchable: recommendMovies) { $0.0 }, wrap(matchable: movieId) { $0.1 }]
	    ...
	    func saveSimilarTVShow<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ similarTVShows: M1, to tvShowId: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(List<TVShow>, Int)> where M1.MatchedType == List<TVShow>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<TVShow>, Int)>] = [wrap(matchable: similarTVShows) { $0.0 }, wrap(matchable: tvShowId) { $0.1 }]
	    ...
	    func saveRecommendTVShow<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ recommendTVShows: M1, to tvShowId: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(List<TVShow>, Int)> where M1.MatchedType == List<TVShow>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<TVShow>, Int)>] = [wrap(matchable: recommendTVShows) { $0.0 }, wrap(matchable: tvShowId) { $0.1 }]
	    ...
	    func getTVShowSeasons<M1: Cuckoo.Matchable>(tvShowId: M1) -> Cuckoo.ProtocolStubFunction<(Int), List<Season>> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSourceProtocol.self, method: "getTVShowSeasons(tvShowId: Int) -> List<Season>", parameterMatchers: matchers))
	    }
	    ...
	    func getTVShowSeasonCasts<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from tvShowId: M1, seasonNumber: M2) -> Cuckoo.ProtocolStubFunction<(Int, Int), List<Cast>> where M1.MatchedType == Int, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Int)>] = [wrap(matchable: tvShowId) { $0.0 }, wrap(matchable: seasonNumber) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSourceProtocol.self, method: "getTVShowSeasonCasts(from: Int, seasonNumber: Int) -> List<Cast>", parameterMatchers: matchers))
	    }
	    
	    func getTVShowSeasonCrews<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from tvShowId: M1, seasonNumber: M2) -> Cuckoo.ProtocolStubFunction<(Int, Int), List<Crew>> where M1.MatchedType == Int, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Int)>] = [wrap(matchable: tvShowId) { $0.0 }, wrap(matchable: seasonNumber) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSourceProtocol.self, method: "getTVShowSeasonCrews(from: Int, seasonNumber: Int) -> List<Crew>", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_TMDBLocalDataSourceProtocol: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func saveSimilarMovie<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ similarMovies: M1, to movieId: M2) -> Cuckoo.__DoNotUse<(List<Movie>, Int), Void> where M1.MatchedType == List<Movie>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<Movie>, Int)>] = [wrap(matchable: similarMovies) { $0.0 }, wrap(matchable: movieId) { $0.1 }]
	    ...
	    @discardableResult
	    func saveRecommendMovie<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ recommendMovies: M1, to movieId: M2) -> Cuckoo.__DoNotUse<(List<Movie>, Int), Void> where M1.MatchedType == List<Movie>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<Movie>, Int)>] = [wrap(matchable: recommendMovies) { $0.0 }, wrap(matchable: movieId) { $0.1 }]
	    ...
	    @discardableResult
	    func saveSimilarTVShow<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ similarTVShows: M1, to tvShowId: M2) -> Cuckoo.__DoNotUse<(List<TVShow>, Int), Void> where M1.MatchedType == List<TVShow>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<TVShow>, Int)>] = [wrap(matchable: similarTVShows) { $0.0 }, wrap(matchable: tvShowId) { $0.1 }]
	    ...
	    @discardableResult
	    func saveRecommendTVShow<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ recommendTVShows: M1, to tvShowId: M2) -> Cuckoo.__DoNotUse<(List<TVShow>, Int), Void> where M1.MatchedType == List<TVShow>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<TVShow>, Int)>] = [wrap(matchable: recommendTVShows) { $0.0 }, wrap(matchable: tvShowId) { $0.1 }]
	    ...
	    @discardableResult
	    func getTVShowSeasons<M1: Cuckoo.Matchable>(tvShowId: M1) -> Cuckoo.__DoNotUse<(Int), List<Season>> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return cuckoo_manager.verify("getTVShowSeasons(tvShowId: Int) -> List<Season>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    ...
	    @discardableResult
	    func getTVShowSeasonCasts<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from tvShowId: M1, seasonNumber: M2) -> Cuckoo.__DoNotUse<(Int, Int), List<Cast>> where M1.MatchedType == Int, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Int)>] = [wrap(matchable: tvShowId) { $0.0 }, wrap(matchable: seasonNumber) { $0.1 }]
	        return cuckoo_manager.verify("getTVShowSeasonCasts(from: Int, seasonNumber: Int) -> List<Cast>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func getTVShowSeasonCrews<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from tvShowId: M1, seasonNumber: M2) -> Cuckoo.__DoNotUse<(Int, Int), List<Crew>> where M1.MatchedType == Int, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Int)>] = [wrap(matchable: tvShowId) { $0.0 }, wrap(matchable: seasonNumber) { $0.1 }]
	        return cuckoo_manager.verify("getTVShowSeasonCrews(from: Int, seasonNumber: Int) -> List<Crew>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
 ...
 class TMDBLocalDataSourceProtocolStub: TMDBLocalDataSourceProtocol {
     ...
     func getTVShowSeasons(tvShowId: Int) -> List<Season>  {
        return DefaultValueRegistry.defaultValue(for: (List<Season>).self)
    }
     ...
     func getTVShowSeasonCasts(from tvShowId: Int, seasonNumber: Int) -> List<Cast>  {
        return DefaultValueRegistry.defaultValue(for: (List<Cast>).self)
    }
    
     func getTVShowSeasonCrews(from tvShowId: Int, seasonNumber: Int) -> List<Crew>  {
        return DefaultValueRegistry.defaultValue(for: (List<Crew>).self)
    }
 ...
 class MockTMDBLocalDataSource: TMDBLocalDataSource, Cuckoo.ClassMock {
    ...
    return cuckoo_manager.call("saveMovie(_: Movie)",
     ...
     override func saveSimilarMovie(_ similarMovies: List<Movie>, to movieId: Int)  {
    ...
    return cuckoo_manager.call("saveSimilarMovie(_: List<Movie>, to: Int)",
            ...
            superclassCall:
                ...
                super.saveSimilarMovie(similarMovies, to: movieId)
                ,
            defaultCall: __defaultImplStub!.saveSimilarMovie(similarMovies, to: movieId))
     ...
     override func saveRecommendMovie(_ recommendMovies: List<Movie>, to movieId: Int)  {
    ...
    return cuckoo_manager.call("saveRecommendMovie(_: List<Movie>, to: Int)",
            ...
            superclassCall:
                ...
                super.saveRecommendMovie(recommendMovies, to: movieId)
                ,
            defaultCall: __defaultImplStub!.saveRecommendMovie(recommendMovies, to: movieId))
    ...
    return cuckoo_manager.call("saveTVShow(_: TVShow)",
     ...
     override func saveSimilarTVShow(_ similarTVShows: List<TVShow>, to tvShowId: Int)  {
    ...
    return cuckoo_manager.call("saveSimilarTVShow(_: List<TVShow>, to: Int)",
            ...
            superclassCall:
                ...
                super.saveSimilarTVShow(similarTVShows, to: tvShowId)
                ,
            defaultCall: __defaultImplStub!.saveSimilarTVShow(similarTVShows, to: tvShowId))
     ...
     override func saveRecommendTVShow(_ recommendTVShows: List<TVShow>, to tvShowId: Int)  {
    ...
    return cuckoo_manager.call("saveRecommendTVShow(_: List<TVShow>, to: Int)",
            ...
            superclassCall:
                ...
                super.saveRecommendTVShow(recommendTVShows, to: tvShowId)
                ,
            defaultCall: __defaultImplStub!.saveRecommendTVShow(recommendTVShows, to: tvShowId))
    ...
    return cuckoo_manager.call("saveTVShowEpisodeImage(_: ImageResult, to: Int, seasonNumber: Int, episodeNumber: Int)",
     ...
     override func getTVShowSeasons(tvShowId: Int) -> List<Season> {
    ...
    return cuckoo_manager.call("getTVShowSeasons(tvShowId: Int) -> List<Season>",
            ...
            superclassCall:
                ...
                super.getTVShowSeasons(tvShowId: tvShowId)
                ,
            defaultCall: __defaultImplStub!.getTVShowSeasons(tvShowId: tvShowId))
     ...
     override func getTVShowSeasonCasts(from tvShowId: Int, seasonNumber: Int) -> List<Cast> {
    ...
    return cuckoo_manager.call("getTVShowSeasonCasts(from: Int, seasonNumber: Int) -> List<Cast>",
            ...
            superclassCall:
                ...
                super.getTVShowSeasonCasts(from: tvShowId, seasonNumber: seasonNumber)
                ,
            defaultCall: __defaultImplStub!.getTVShowSeasonCasts(from: tvShowId, seasonNumber: seasonNumber))
     ...
     override func getTVShowSeasonCrews(from tvShowId: Int, seasonNumber: Int) -> List<Crew> {
    ...
    return cuckoo_manager.call("getTVShowSeasonCrews(from: Int, seasonNumber: Int) -> List<Crew>",
            ...
            superclassCall:
                ...
                super.getTVShowSeasonCrews(from: tvShowId, seasonNumber: seasonNumber)
                ,
            defaultCall: __defaultImplStub!.getTVShowSeasonCrews(from: tvShowId, seasonNumber: seasonNumber))
    ...
    return cuckoo_manager.call("savePerson(_: People)",
	 ...
	 struct __StubbingProxy_TMDBLocalDataSource: Cuckoo.StubbingProxy {
	    ...
	    func saveSimilarMovie<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ similarMovies: M1, to movieId: M2) -> Cuckoo.ClassStubNoReturnFunction<(List<Movie>, Int)> where M1.MatchedType == List<Movie>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<Movie>, Int)>] = [wrap(matchable: similarMovies) { $0.0 }, wrap(matchable: movieId) { $0.1 }]
	    ...
	    func saveRecommendMovie<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ recommendMovies: M1, to movieId: M2) -> Cuckoo.ClassStubNoReturnFunction<(List<Movie>, Int)> where M1.MatchedType == List<Movie>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<Movie>, Int)>] = [wrap(matchable: recommendMovies) { $0.0 }, wrap(matchable: movieId) { $0.1 }]
	    ...
	    func saveSimilarTVShow<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ similarTVShows: M1, to tvShowId: M2) -> Cuckoo.ClassStubNoReturnFunction<(List<TVShow>, Int)> where M1.MatchedType == List<TVShow>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<TVShow>, Int)>] = [wrap(matchable: similarTVShows) { $0.0 }, wrap(matchable: tvShowId) { $0.1 }]
	    ...
	    func saveRecommendTVShow<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ recommendTVShows: M1, to tvShowId: M2) -> Cuckoo.ClassStubNoReturnFunction<(List<TVShow>, Int)> where M1.MatchedType == List<TVShow>, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(List<TVShow>, Int)>] = [wrap(matchable: recommendTVShows) { $0.0 }, wrap(matchable: tvShowId) { $0.1 }]
	    ...
	    func getTVShowSeasons<M1: Cuckoo.Matchable>(tvShowId: M1) -> Cuckoo.ClassStubFunction<(Int), List<Season>> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: tvShowId) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSource.self, method: "getTVShowSeasons(tvShowId: Int) -> List<Season>", parameterMatchers: matchers))
	    }
	    
	    func getTVShowSeasonCasts<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from tvShowId: M1, seasonNumber: M2) -> Cuckoo.ClassStubFunction<(Int, Int), List<Cast>> where M1.MatchedType == Int, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Int)>] = [wrap(matchable: tvShowId) { $0.0 }, wrap(matchable: seasonNumber) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSource.self, method: "getTVShowSeasonCasts(from: Int, seasonNumber: Int) -> List<Cast>", parameterMatchers: matchers))
	    }
	    
	    func getTVShowSeasonCrews<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from tvShowId: M1, seasonNumber: M2) -> Cuckoo.ClassStubFunction<(Int, Int), List<Crew>> where M1.MatchedType == Int, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Int)>] = [wrap(matchable: tvShowId) { $0.0 }, wrap(matchable: seasonNumber) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSource.self, method: "getTVShowSeasonCrews(from: Int, seasonNumber: Int) -> List<Crew>", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: TMDB/TMDBRepository/TMDBRepository.swift at 2021-01-13 19:21:27 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBSession.swift at 2021-01-13 19:21:27 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLRequestBuilder.swift at 2021-01-13 19:21:27 +0000
...
import Foundation
 ...
 class MockTMDBURLRequestBuilderProtocol: TMDBURLRequestBuilderProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("getTrendingURLRequest(page: Int, time: TrendingTime, type: TrendingMediaType) -> URLRequest",
            parameters: (page, time, type),
            escapingParameters: (page, time, type),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getTrendingURLRequest(page: page, time: time, type: type))
    ...
    return cuckoo_manager.call("getSearchKeywordURLRequest(query: String, page: Int) -> URLRequest",
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getSearchKeywordURLRequest(query: query, page: page))
    ...
    return cuckoo_manager.call("getGuestSessionURLRequest() -> URLRequest",
            parameters: (),
            escapingParameters: (),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getGuestSessionURLRequest())
    ...
    return cuckoo_manager.call("getPostMovieRatingURLRequest(movieId: Int, rate: Double) -> URLRequest",
            parameters: (movieId, rate),
            escapingParameters: (movieId, rate),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getPostMovieRatingURLRequest(movieId: movieId, rate: rate))
    ...
    return cuckoo_manager.call("getPostTVShowRatingURLRequest(tvId: Int, rate: Double) -> URLRequest",
            parameters: (tvId, rate),
            escapingParameters: (tvId, rate),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getPostTVShowRatingURLRequest(tvId: tvId, rate: rate))
	 ...
	 struct __StubbingProxy_TMDBURLRequestBuilderProtocol: Cuckoo.StubbingProxy {
	    ...
	    func getTrendingURLRequest<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(page: M1, time: M2, type: M3) -> Cuckoo.ProtocolStubFunction<(Int, TrendingTime, TrendingMediaType), URLRequest> where M1.MatchedType == Int, M2.MatchedType == TrendingTime, M3.MatchedType == TrendingMediaType {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, TrendingTime, TrendingMediaType)>] = [wrap(matchable: page) { $0.0 }, wrap(matchable: time) { $0.1 }, wrap(matchable: type) { $0.2 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBURLRequestBuilderProtocol.self, method: "getTrendingURLRequest(page: Int, time: TrendingTime, type: TrendingMediaType) -> URLRequest", parameterMatchers: matchers))
	    }
	    ...
	    func getSearchKeywordURLRequest<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(query: M1, page: M2) -> Cuckoo.ProtocolStubFunction<(String, Int), URLRequest> where M1.MatchedType == String, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(String, Int)>] = [wrap(matchable: query) { $0.0 }, wrap(matchable: page) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBURLRequestBuilderProtocol.self, method: "getSearchKeywordURLRequest(query: String, page: Int) -> URLRequest", parameterMatchers: matchers))
	    }
	    
	    func getGuestSessionURLRequest() -> Cuckoo.ProtocolStubFunction<(), URLRequest> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBURLRequestBuilderProtocol.self, method: "getGuestSessionURLRequest() -> URLRequest", parameterMatchers: matchers))
	    }
	    
	    func getPostMovieRatingURLRequest<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(movieId: M1, rate: M2) -> Cuckoo.ProtocolStubFunction<(Int, Double), URLRequest> where M1.MatchedType == Int, M2.MatchedType == Double {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Double)>] = [wrap(matchable: movieId) { $0.0 }, wrap(matchable: rate) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBURLRequestBuilderProtocol.self, method: "getPostMovieRatingURLRequest(movieId: Int, rate: Double) -> URLRequest", parameterMatchers: matchers))
	    }
	    
	    func getPostTVShowRatingURLRequest<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(tvId: M1, rate: M2) -> Cuckoo.ProtocolStubFunction<(Int, Double), URLRequest> where M1.MatchedType == Int, M2.MatchedType == Double {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Double)>] = [wrap(matchable: tvId) { $0.0 }, wrap(matchable: rate) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBURLRequestBuilderProtocol.self, method: "getPostTVShowRatingURLRequest(tvId: Int, rate: Double) -> URLRequest", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_TMDBURLRequestBuilderProtocol: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getTrendingURLRequest<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(page: M1, time: M2, type: M3) -> Cuckoo.__DoNotUse<(Int, TrendingTime, TrendingMediaType), URLRequest> where M1.MatchedType == Int, M2.MatchedType == TrendingTime, M3.MatchedType == TrendingMediaType {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, TrendingTime, TrendingMediaType)>] = [wrap(matchable: page) { $0.0 }, wrap(matchable: time) { $0.1 }, wrap(matchable: type) { $0.2 }]
	        return cuckoo_manager.verify("getTrendingURLRequest(page: Int, time: TrendingTime, type: TrendingMediaType) -> URLRequest", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    ...
	    @discardableResult
	    func getSearchKeywordURLRequest<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(query: M1, page: M2) -> Cuckoo.__DoNotUse<(String, Int), URLRequest> where M1.MatchedType == String, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(String, Int)>] = [wrap(matchable: query) { $0.0 }, wrap(matchable: page) { $0.1 }]
	        return cuckoo_manager.verify("getSearchKeywordURLRequest(query: String, page: Int) -> URLRequest", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func getGuestSessionURLRequest() -> Cuckoo.__DoNotUse<(), URLRequest> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return cuckoo_manager.verify("getGuestSessionURLRequest() -> URLRequest", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func getPostMovieRatingURLRequest<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(movieId: M1, rate: M2) -> Cuckoo.__DoNotUse<(Int, Double), URLRequest> where M1.MatchedType == Int, M2.MatchedType == Double {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Double)>] = [wrap(matchable: movieId) { $0.0 }, wrap(matchable: rate) { $0.1 }]
	        return cuckoo_manager.verify("getPostMovieRatingURLRequest(movieId: Int, rate: Double) -> URLRequest", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func getPostTVShowRatingURLRequest<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(tvId: M1, rate: M2) -> Cuckoo.__DoNotUse<(Int, Double), URLRequest> where M1.MatchedType == Int, M2.MatchedType == Double {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, Double)>] = [wrap(matchable: tvId) { $0.0 }, wrap(matchable: rate) { $0.1 }]
	        return cuckoo_manager.verify("getPostTVShowRatingURLRequest(tvId: Int, rate: Double) -> URLRequest", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLSessionDataTaskProtocol.swift at 2021-01-13 19:21:27 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLSessionProtocol.swift at 2021-01-13 19:21:27 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBUserSetting/TMDBUserSetting.swift at 2021-01-13 19:21:27 +0000
...
import Foundation
 ...
 class MockTMDBUserSettingProtocol: TMDBUserSettingProtocol, Cuckoo.ProtocolMock {
    ...
    private var __defaultImplStub: TMDBUserSettingProtocol?
     ...
     var movieGenres: [Genre] {
        get {
            return cuckoo_manager.getter("movieGenres",
                superclassCall:
                    
                    Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                    ,
                defaultCall: __defaultImplStub!.movieGenres)
        }
     ...
     var tvShowGenres: [Genre] {
        get {
            return cuckoo_manager.getter("tvShowGenres",
                superclassCall:
                    
                    Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                    ,
                defaultCall: __defaultImplStub!.tvShowGenres)
        }
     ...
     var guestSession: GuestSession? {
        get {
            return cuckoo_manager.getter("guestSession",
                superclassCall:
                    
                    Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                    ,
                defaultCall: __defaultImplStub!.guestSession)
        }
        
        set {
            cuckoo_manager.setter("guestSession",
                value: newValue,
                superclassCall:
                    
                    Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                    ,
                defaultCall: __defaultImplStub!.guestSession = newValue)
        }
     ...
     var apiKey: String {
        get {
            return cuckoo_manager.getter("apiKey",
                superclassCall:
                    
                    Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                    ,
                defaultCall: __defaultImplStub!.apiKey)
        }
    ...
    return cuckoo_manager.call("getYoutubeVideoURL(key: String) -> URL?",
	 ...
	 struct __StubbingProxy_TMDBUserSettingProtocol: Cuckoo.StubbingProxy {
	    ...
	    var movieGenres: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockTMDBUserSettingProtocol, [Genre]> {
	        return .init(manager: cuckoo_manager, name: "movieGenres")
	    }
	    
	    
	    var tvShowGenres: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockTMDBUserSettingProtocol, [Genre]> {
	        return .init(manager: cuckoo_manager, name: "tvShowGenres")
	    }
	    
	    
	    var guestSession: Cuckoo.ProtocolToBeStubbedOptionalProperty<MockTMDBUserSettingProtocol, GuestSession> {
	        return .init(manager: cuckoo_manager, name: "guestSession")
	    }
	    
	    
	    var apiKey: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockTMDBUserSettingProtocol, String> {
	        return .init(manager: cuckoo_manager, name: "apiKey")
	    }
	 ...
	 struct __VerificationProxy_TMDBUserSettingProtocol: Cuckoo.VerificationProxy {
	    ...
	    var movieGenres: Cuckoo.VerifyReadOnlyProperty<[Genre]> {
	        return .init(manager: cuckoo_manager, name: "movieGenres", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var tvShowGenres: Cuckoo.VerifyReadOnlyProperty<[Genre]> {
	        return .init(manager: cuckoo_manager, name: "tvShowGenres", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var guestSession: Cuckoo.VerifyOptionalProperty<GuestSession> {
	        return .init(manager: cuckoo_manager, name: "guestSession", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var apiKey: Cuckoo.VerifyReadOnlyProperty<String> {
	        return .init(manager: cuckoo_manager, name: "apiKey", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
 ...
 class TMDBUserSettingProtocolStub: TMDBUserSettingProtocol {
     ...
     var movieGenres: [Genre] {
        get {
            return DefaultValueRegistry.defaultValue(for: ([Genre]).self)
        }
     ...
     var guestSession: GuestSession? {
        get {
            return DefaultValueRegistry.defaultValue(for: (GuestSession?).self)
        }
