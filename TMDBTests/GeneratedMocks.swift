// MARK: - Mocks generated from file: TMDB/TMDBLocalDataSource/TMDBLocalDataSource.swift at 2020-07-03 15:46:23 +0000
...
import RealmSwift
 ...
 class MockTMDBLocalDataSourceProtocol: TMDBLocalDataSourceProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("getMovieCredit(id: Int) -> CreditResult?",
            parameters: (id),
            escapingParameters: (id),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getMovieCredit(id: id))
    ...
    return cuckoo_manager.call("saveMovieCredit(_: CreditResult)",
            parameters: (creditResult),
            escapingParameters: (creditResult),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.saveMovieCredit(creditResult))
    ...
    return cuckoo_manager.call("saveTrendings(_: List<Trending>)",
	 ...
	 struct __StubbingProxy_TMDBLocalDataSourceProtocol: Cuckoo.StubbingProxy {
	    ...
	    func getMovieCredit<M1: Cuckoo.Matchable>(id: M1) -> Cuckoo.ProtocolStubFunction<(Int), CreditResult?> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: id) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSourceProtocol.self, method: "getMovieCredit(id: Int) -> CreditResult?", parameterMatchers: matchers))
	    }
	    ...
	    func saveMovieCredit<M1: Cuckoo.Matchable>(_ creditResult: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(CreditResult)> where M1.MatchedType == CreditResult {
	        let matchers: [Cuckoo.ParameterMatcher<(CreditResult)>] = [wrap(matchable: creditResult) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSourceProtocol.self, method: "saveMovieCredit(_: CreditResult)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_TMDBLocalDataSourceProtocol: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getMovieCredit<M1: Cuckoo.Matchable>(id: M1) -> Cuckoo.__DoNotUse<(Int), CreditResult?> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: id) { $0 }]
	        return cuckoo_manager.verify("getMovieCredit(id: Int) -> CreditResult?", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    ...
	    @discardableResult
	    func saveMovieCredit<M1: Cuckoo.Matchable>(_ creditResult: M1) -> Cuckoo.__DoNotUse<(CreditResult), Void> where M1.MatchedType == CreditResult {
	        let matchers: [Cuckoo.ParameterMatcher<(CreditResult)>] = [wrap(matchable: creditResult) { $0 }]
	        return cuckoo_manager.verify("saveMovieCredit(_: CreditResult)", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
 ...
 class TMDBLocalDataSourceProtocolStub: TMDBLocalDataSourceProtocol {
     ...
     func getMovieCredit(id: Int) -> CreditResult?  {
        return DefaultValueRegistry.defaultValue(for: (CreditResult?).self)
    }
 ...
 class MockTMDBLocalDataSource: TMDBLocalDataSource, Cuckoo.ClassMock {
    ...
    return cuckoo_manager.call("saveMovies(_: List<Movie>)",
     ...
     override func saveMovieCredit(_ creditResult: CreditResult)  {
    ...
    return cuckoo_manager.call("saveMovieCredit(_: CreditResult)",
            ...
            superclassCall:
                ...
                super.saveMovieCredit(creditResult)
                ,
            defaultCall: __defaultImplStub!.saveMovieCredit(creditResult))
     ...
     override func getMovieCredit(id: Int) -> CreditResult? {
    ...
    return cuckoo_manager.call("saveTrendings(_: List<Trending>)",
	 ...
	 struct __StubbingProxy_TMDBLocalDataSource: Cuckoo.StubbingProxy {
	    ...
	    func saveMovieCredit<M1: Cuckoo.Matchable>(_ creditResult: M1) -> Cuckoo.ClassStubNoReturnFunction<(CreditResult)> where M1.MatchedType == CreditResult {
	        let matchers: [Cuckoo.ParameterMatcher<(CreditResult)>] = [wrap(matchable: creditResult) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSource.self, method: "saveMovieCredit(_: CreditResult)", parameterMatchers: matchers))
	    }
	    
	    func getMovieCredit<M1: Cuckoo.Matchable>(id: M1) -> Cuckoo.ClassStubFunction<(Int), CreditResult?> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: id) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBLocalDataSource.self, method: "getMovieCredit(id: Int) -> CreditResult?", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: TMDB/TMDBRepository/TMDBRepository.swift at 2020-07-03 15:46:23 +0000
...
import Foundation
 ...
 class MockTMDBRepositoryProtocol: TMDBRepositoryProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("getMovieCredit(from: Int, completion: @escaping (Result<CreditResult, Error>) -> Void)",
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getMovieCredit(from: movieId, completion: completion))
    ...
    return cuckoo_manager.call("getImageURL(from: String) -> URL?",
	 ...
	 struct __StubbingProxy_TMDBRepositoryProtocol: Cuckoo.StubbingProxy {
	    ...
	    func getMovieCredit<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from movieId: M1, completion: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(Int, (Result<CreditResult, Error>) -> Void)> where M1.MatchedType == Int, M2.MatchedType == (Result<CreditResult, Error>) -> Void {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, (Result<CreditResult, Error>) -> Void)>] = [wrap(matchable: movieId) { $0.0 }, wrap(matchable: completion) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBRepositoryProtocol.self, method: "getMovieCredit(from: Int, completion: @escaping (Result<CreditResult, Error>) -> Void)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_TMDBRepositoryProtocol: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getMovieCredit<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from movieId: M1, completion: M2) -> Cuckoo.__DoNotUse<(Int, (Result<CreditResult, Error>) -> Void), Void> where M1.MatchedType == Int, M2.MatchedType == (Result<CreditResult, Error>) -> Void {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, (Result<CreditResult, Error>) -> Void)>] = [wrap(matchable: movieId) { $0.0 }, wrap(matchable: completion) { $0.1 }]
	        return cuckoo_manager.verify("getMovieCredit(from: Int, completion: @escaping (Result<CreditResult, Error>) -> Void)", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
 ...
 class MockTMDBRepository: TMDBRepository, Cuckoo.ClassMock {
    ...
    private var __defaultImplStub: TMDBRepository?
     ...
     override func getMovieCredit(from movieId: Int, completion: @escaping (Result<CreditResult, Error>) -> Void)  {
    ...
    return cuckoo_manager.call("getMovieCredit(from: Int, completion: @escaping (Result<CreditResult, Error>) -> Void)",
            ...
            superclassCall:
                ...
                super.getMovieCredit(from: movieId, completion: completion)
                ,
            defaultCall: __defaultImplStub!.getMovieCredit(from: movieId, completion: completion))
    ...
    return cuckoo_manager.call("getImageURL(from: String) -> URL?",
	 ...
	 struct __StubbingProxy_TMDBRepository: Cuckoo.StubbingProxy {
	    ...
	    func getMovieCredit<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from movieId: M1, completion: M2) -> Cuckoo.ClassStubNoReturnFunction<(Int, (Result<CreditResult, Error>) -> Void)> where M1.MatchedType == Int, M2.MatchedType == (Result<CreditResult, Error>) -> Void {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, (Result<CreditResult, Error>) -> Void)>] = [wrap(matchable: movieId) { $0.0 }, wrap(matchable: completion) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTMDBRepository.self, method: "getMovieCredit(from: Int, completion: @escaping (Result<CreditResult, Error>) -> Void)", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBSession.swift at 2020-07-03 15:46:23 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLRequestBuilder.swift at 2020-07-03 15:46:23 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLSessionDataTaskProtocol.swift at 2020-07-03 15:46:23 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBServices/TMDBURLSessionProtocol.swift at 2020-07-03 15:46:23 +0000
...
// MARK: - Mocks generated from file: TMDB/TMDBUserSetting/TMDBUserSetting.swift at 2020-07-03 15:46:23 +0000
