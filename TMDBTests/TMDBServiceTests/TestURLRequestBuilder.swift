...
class TestURLRequestBuilder: XCTestCase {
    ...
    func testTVShowDetailURL() {
        ...
        let urlMatcher = "https://api.themoviedb.org/3/tv/3?language=en-US&append_to_response=keywords,similar,recommendations,credits,reviews&api_key=6823a37cea296ab67c0a2a6ce3cb4ec5"
        expect(matchRequest.url?.absoluteString).to(equal(urlMatcher))
    }
